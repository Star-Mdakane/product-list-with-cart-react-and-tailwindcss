const AddItemButton = ({ handleClick }) => {
    return (
        <button type="button" onClick={handleClick} aria-label='Add to cart' className='w-40 h-11 p-3 gap-2 bg-white border border-[#AD8A85] hover:border-[#C73B0F] rounded-full absolute left-1/2 translate-x-[-50%] bottom-0 translate-y-1/2 flex items-center justify-center cursor-pointer group'>
