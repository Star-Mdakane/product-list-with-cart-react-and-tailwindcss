...
const CartModal = ({ setOpenModal }) => {
    ...
    return (
        <div className='z-10 fixed w-screen min-h-screen bg-black/50 left-0 top-0 md:flex items-center justify-center overflow-hidden'>
            <div className='bg-white w-93.75 md:w-172 lg:w-148 mx-auto mt-10 md:mt-0 flex flex-col rounded-t-xl md:rounded-xl pt-10 px-6 pb-6 gap-8 overflow-y-auto max-h-screen'>
