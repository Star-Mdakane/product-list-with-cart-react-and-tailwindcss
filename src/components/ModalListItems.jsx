    ...
    return (
        <>
            <li className='flex items-center justify-between pb-4 border-b border-rose-100'>
                ...
                <button type='button' aria-label='Remove item' className='w-5 h-5 rounded-full border border-[#AD8A85] flex items-center justify-center hover:border-[#260F08] cursor-pointer group'>
